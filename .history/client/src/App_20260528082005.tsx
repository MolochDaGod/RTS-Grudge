...
const PlayEntrypoint = lazy(() => import("./game/PlayEntrypoint"));
...
function App() {
  ...
  const {
    ...
    goToCombat2d, goToIslandV2, goToWallet, goToPlayEntrypoint,
  } = useGame();
...
{
  phase === "playEntrypoint" && (
    <Suspense fallback={ null }> <PlayEntrypoint /></Suspense >
      )
}
