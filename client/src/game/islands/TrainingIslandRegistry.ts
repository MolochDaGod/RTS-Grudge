...
export const TRAINING_ISLANDS: TrainingIsland[] = [
  ...
  },
  {
    ...
    enemySpawnRadius: 25,
    boundsRadius: 30,
    rewards: { xp: 3000, gold: 1500, unlocks: ["pirate_king_title", "ti_atoll"] },
    ambientColor: "#ffaa88",
    fogColor: "#cc8866",
    fogDensity: 0.02,
  },
  {
    ...
    subtitle: "The Hidden Gauntlet",
    sceneNodeName: "SmallIslands",
    difficulty: 7,
    order: 7,
    description: "Scattered islets once used by smugglers to stash cursed loot. Every creature here fights with reckless abandon — ranged casters bombard from the rocks while berserkers charge the shallows.",
    unlockRequirement: "ti_fort",
    defaultBehavior: "berserker",
    enemyEmotes: ["taunt", "rally", "warn", "laugh", "celebrate", "fear"],
    waves: [
      { enemies: [{ type: "thrower_brute", count: 3 }, { type: "thrower_soldier", count: 3 }, { type: "pirate", count: 4 }], spawnDelay: 1.0 },
      { enemies: [{ type: "thrower_assassin", count: 4 }, { type: "ninja", count: 4 }, { type: "raptor", count: 3 }], spawnDelay: 0.8, behaviorOverride: "ambush" },
      { enemies: [{ type: "thrower_berserker", count: 3 }, { type: "demon", count: 3 }, { type: "yeti", count: 2 }, { type: "alien", count: 2 }], spawnDelay: 0.7, behaviorOverride: "coordinated" },
      { enemies: [{ type: "dragon", count: 1 }, { type: "triceratops", count: 2 }, { type: "mushroom_king", count: 2 }, { type: "thrower_brute", count: 3 }], spawnDelay: 0.6, behaviorOverride: "berserker" },
      { enemies: [{ type: "trex", count: 1 }, { type: "demon", count: 4 }, { type: "alien", count: 3 }, { type: "thrower_berserker", count: 3 }], spawnDelay: 0.5, behaviorOverride: "aggressive" },
      { enemies: [{ type: "dragon", count: 2 }, { type: "trex", count: 1 }, { type: "raptor", count: 4 }, { type: "yeti", count: 3 }], spawnDelay: 0.4 },
    ],
    bossType: "trex",
    ...
    enemySpawnRadius: 25,
    boundsRadius: 30,
    rewards: { xp: 5000, gold: 2500, unlocks: ["smuggler_king_title"] },
    ambientColor: "#dd8866",
    fogColor: "#aa6644",
    fogDensity: 0.025,
  },
