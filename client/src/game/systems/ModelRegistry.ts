...
// ---------------------------------------------------------------------------
// Grudge6 BRB Bip001 animation packs (from animationsofbrrb.zip)
// Defined BEFORE ANIMATION_PACKS so they can be spread into it.
...
const BRB_EMOTES_PACK: AnimationPackEntry = {
  id: "grudge6_brb_emotes",
  name: "Grudge6 BRB — Emotes/Dances",
  basePath: "/models/animations/grudge6_brb/emotes",
  combatStyle: "universal",
  animations: [
    { name: "victory",   file: "Bboy Hip Hop Move.glb" },
    { name: "victory",   file: "Hip Hop Dancing.glb" },
    { name: "idle_alt",  file: "Silly Dancing.glb" },
    { name: "idle_alt2", file: "Standing Taunt Battlecry.glb" },
  ],
};

const BRB_SWORD_SHIELD_PACK: AnimationPackEntry = {
  id: "grudge6_brb_sword_shield",
  name: "Grudge6 BRB — Sword + Shield Combat",
  basePath: "/models/animations/grudge6_brb/sword_shield",
  combatStyle: "melee",
  animations: [
    { name: "attack",        file: "Sword And Shield Attack.glb" },
    { name: "combo2",        file: "Sword And Shield Attack (1).glb" },
    { name: "heavyAttack",   file: "Sword And Shield Attack (2).glb" },
    { name: "combo3",        file: "Sword And Shield Slash.glb" },
    { name: "fastCombo",     file: "Sword And Shield Slash 1.glb" },
    { name: "counterStrike", file: "Sword And Shield Slash (1).glb" },
    { name: "swordBlaster",  file: "Sword And Shield Casting.glb" },
    { name: "whirlwind",     file: "Sword And Shield Power Up.glb" },
    { name: "spinSlash",     file: "Northern Soul Spin Combo.glb" },
  ],
};

const BRB_GREATSWORD_PACK: AnimationPackEntry = {
  id: "grudge6_brb_greatsword",
  name: "Grudge6 BRB — Greatsword / 2H Combat",
  basePath: "/models/animations/grudge6_brb/greatsword",
  combatStyle: "melee",
  animations: [
    { name: "attack",      file: "Great Sword Slash.glb" },
    { name: "combo2",      file: "Great Sword Slash (1).glb" },
    { name: "fastCombo",   file: "Two Hand Sword Combo.glb" },
    { name: "heavyAttack", file: "Two Hand Club Combo.glb" },
  ],
};

const BRB_ONEHANDED_PACK: AnimationPackEntry = {
  id: "grudge6_brb_onehanded",
  name: "Grudge6 BRB — One-Handed (Axe/Dagger/Mace) Combat",
  basePath: "/models/animations/grudge6_brb/onehanded",
  combatStyle: "melee",
  animations: [
    { name: "attack",    file: "One Hand Sword Combo.glb" },
    { name: "combo2",    file: "One Hand Club Combo.glb" },
    { name: "fastCombo", file: "Dual Weapon Combo.glb" },
  ],
};

const BRB_MAGIC_PACK: AnimationPackEntry = {
  id: "grudge6_brb_magic",
  name: "Grudge6 BRB — Magic (Staff/Wand/Tome)",
  basePath: "/models/animations/grudge6_brb/magic",
  combatStyle: "caster",
  animations: [
    { name: "hadouken",      file: "Spell Casting.glb" },
    { name: "attack",        file: "Standing 1H Cast Spell 01.glb" },
    { name: "swordBlaster",  file: "Standing 2H Cast Spell 01.glb" },
    { name: "earthquake",    file: "Standing 2H Magic Area Attack 01.glb" },
    { name: "spinSlash",     file: "Standing 2H Magic Area Attack 02.glb" },
    { name: "swordBlaster2", file: "Standing 2H Magic Attack 01.glb" },
    { name: "tatsumaki",     file: "Standing 2H Magic Attack 03.glb" },
    { name: "shoryuken",     file: "Standing 2H Magic Attack 04.glb" },
  ],
};
